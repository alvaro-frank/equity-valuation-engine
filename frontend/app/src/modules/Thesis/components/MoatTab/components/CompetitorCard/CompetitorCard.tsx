...
export function CompetitorCard({ competitor }: CompetitorCardProps) {
  return (
    <div className="bg-surface-container-lowest p-6 rounded-2xl border border-outline-variant/50 hover:border-primary/30 transition-all hover:shadow-sm cursor-pointer group">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h4 className="font-bold text-on-surface text-sm flex items-center gap-2 group-hover:text-primary transition-colors">
          {competitor.name}
