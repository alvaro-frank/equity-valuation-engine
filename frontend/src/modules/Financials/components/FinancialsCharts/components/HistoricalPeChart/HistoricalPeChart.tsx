...
import { formatMultiplier } from '@/common/utils/formatters';

interface HistoricalPeChartProps {
  data: ChartDataPoint[];
}

export function HistoricalPeChart({ data }: HistoricalPeChartProps) {
  return (
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Tooltip
            ...
            formatter={(value: any) => [formatMultiplier(value), undefined]}
          />
