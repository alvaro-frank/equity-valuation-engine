...
export function OpExBreakdownChart({ data }: OpExBreakdownChartProps) {
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Bar 
            ...
            name={t('financials.charts.research_and_development', 'Research & Development')} 
            fill="var(--primary)" 
            radius={[4, 4, 0, 0]}
          />
          <Bar 
            dataKey="sga" 
            name={t('financials.charts.sga', 'SG&A')} 
            fill="var(--tertiary)" 
            radius={[4, 4, 0, 0]} 
          />
        </BarChart>
