...
export interface FilingsErrorDetails {
  key: number | string;
  details: {
    title: string;
    message: string;
...
interface FilingsErrorStateProps {
  errorState: FilingsErrorDetails;
  onReset: () => void;
}

export function FilingsErrorState({ errorState, onReset }: FilingsErrorStateProps) {
